...
class Hyperparams:
    ...
    # data
    #data = r'C:/Users/benti/DCTTS/data/LJSpeech-1.1' 
    data = r'C:/Users/benti/DCTTS/data/AG'

    test_data = 'harvard_sentences.txt'
    vocab = "PE abcdefghijklmnopqrstuvwxyz'.?" # P: Padding, E: EOS.
    
    max_N = 180 # Maximum number of characters. # 180
    ...
    logdir = "logdir/TEST1"
    sampledir = 'samples'
    restoredir = "/logdir/LJ01" # location of pre-trained LJSpeech-1.0 model w/ checkpoint
    B = 16 # batch size
